...
train_dataset = DeepfakeAudioDataset(train_df, data_dir / "training-set")
val_dataset = DeepfakeAudioDataset(val_df, data_dir / "validation-set")
...
print(f'res_tssdnet_model model loaded: {model}')
