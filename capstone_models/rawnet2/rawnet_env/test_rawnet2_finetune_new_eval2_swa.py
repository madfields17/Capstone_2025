...
output_file = Path("finetune_evaluation_new_evaluation_set_2_swa.csv")
merge_output_file = Path("finetune_evaluation_new_evaluation_set_2_swa_merged.csv")
rawnet2_config_path = Path("model_config_RawNet.yaml")
rawnet2_model_path = Path("swa_rawnet2.pth")
